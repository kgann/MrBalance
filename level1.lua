...
physics.start(); physics.setGravity(0, 8); physics.pause()
...
local function localDrag(e)
  gameUI.dragBody(e, {maxForce = 10, frequency = 10, center = true})
end

local function createJoint(prev, new)
  local joint = physics.newJoint("pivot", prev, new, prev.x, prev.contentBounds.yMin)
  joint:setLimits( 100, 200 )
end
...
local function onCollision(e)
  if(e.phase == "began"
    and e.object2.ball
    and (e.object1.stick or e.object1.ball)
    and e.object1 == previousBody) then
